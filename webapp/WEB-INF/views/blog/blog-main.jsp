	...
	<div id="container">
		...
		<div id="wrapper">
			<div id="content">
				...
				<ul class="blog-list">
					<c:forEach items="${ postlist}" var="postlistvo">
						<li><a
							href="${pageContext.request.contextPath}/${id}/${postlistvo.categoryNo}/${postlistvo.no}">${postlistvo.title }</a>
							<span>${postlistvo.regDate }</span></li>
					</c:forEach>
		...
		<div id="extra">
			<div class="blog-logo">
				<img src="${pageContext.request.contextPath}/uploads/images/${blogVo.logo}">
			</div>
		</div>
		...
		<div id="navigation">
			<h2>카테고리</h2>
			<ul>
				<c:forEach items="${ categoryList}" var="categorylistvo">
						<li><a
							href="${pageContext.request.contextPath}/${id}/${categorylistvo.no}/0">${categorylistvo.name }</a>
				</c:forEach>
			</ul>
		</div>
